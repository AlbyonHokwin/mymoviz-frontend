...
function Movie(props) {
  ...
  let croppedOverview = props.overview;
  props.overview.length >= 247 && (croppedOverview = croppedOverview.replace(/^(.{1,250})\W.*/,"$1..."));
    ...
    <div className={styles.card}>
      ...
      <div className={styles.textContainer}>
        <div>
          ...
          <p className={styles.description}>{croppedOverview}</p>
        </div>
